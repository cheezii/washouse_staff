              ...
              children: [
                Column(
                  ...
                  children: [
                    ...
                    Text(
                      order_infomation.orderedDetails![index].unit!.toLowerCase().trim() == 'kg'
                                                    ...
                                                    return AlertDialog(
                                                      ...
                                                      content: Column(
                                                        ...
                                                        children: [
                                                          ...
                                                          Text('Bạn có chắc chắn muốn cập nhật trạng thái của món hàng đến trạng thái tiếp theo?'),
                                                        ],
                                                      ),
                                                      actions: [
                                                        TextButton(
                                              ...
                                              onPressed: () async {
                                                ...
                                                await showDialog(
                                                    ...
                                                    builder: (context) => AlertDialog(
                                                          ...
                                                          title: const Align(
                                                            alignment: Alignment.center,
                                                            child: Text('Cập nhật số lượng/khối lượng'),
                                                          ),
                                                          content: Column(
                                                            mainAxisSize: MainAxisSize.min,
                                                            children: [
                                                              TextFormField(
                                                                ...
                                                                decoration: InputDecoration(
                                                                  ...
                                                                  labelStyle: const TextStyle(
                                                                      color: textBoldColor, fontSize: 18, fontWeight: FontWeight.w500),
                                                                  hintStyle: TextStyle(
                                                                    fontSize: 16,
                                                                ...
                                                                onChanged: (newValue) {
                                                                  if (newValue.isNotEmpty) {
                                                                    newMeasurement = double.tryParse(newValue);
                                                                  } // Convert input to double
                                                                },
                                                                keyboardType: const TextInputType.numberWithOptions(
                                                                    decimal: true), // Set keyboard type to number with decimal option
                                                                inputFormatters: <TextInputFormatter>[
                                                                  FilteringTextInputFormatter.allow(RegExp(
                                                                      r'^\d+\.?\d{0,1}')), // Allow only digits with optional decimal up to 1 decimal places
                                                                ],
                                                              ),
                                                              const SizedBox(height: 20),
                                                              TextFormField(
                                                                ...
                                                                decoration: InputDecoration(
                                                                  labelText: 'Ghi chú của nhân viên',
                                                                  labelStyle: const TextStyle(
                                                                      color: textBoldColor, fontSize: 18, fontWeight: FontWeight.w500),
                                                                  hintStyle: TextStyle(
                                                                    fontSize: 16,
